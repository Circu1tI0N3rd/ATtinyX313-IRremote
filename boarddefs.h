...
//ATtiny2313 (hope it also supports ATtiny4313)
#elif defined(__AVR_ATtinyX313__)
	#define IR_USE_TIMER1   // tx = pin 12
...
#elif defined(__AVR_ATtinyX313__) //Interrupt Mask Register changed on ATtiny2313
#	define TIMER_ENABLE_INTR   (TIMSK = _BV(OCIE1A))
...
# 	define SEND_PIN  6
#elif defined(__AVR_ATtinyX313__)
# 	define SEND_PIN  12      //ATtiny2313 has OC1A on different pin
#else
